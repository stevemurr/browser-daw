...
async function AudioEngineModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  return locateFile('audio_engine_node.wasm');
}
...
var _engine_set_eq_band = Module['_engine_set_eq_band'] = makeInvalidEarlyAccess('_engine_set_eq_band');
var _engine_set_eq_enabled = Module['_engine_set_eq_enabled'] = makeInvalidEarlyAccess('_engine_set_eq_enabled');
...
var _engine_seek = Module['_engine_seek'] = makeInvalidEarlyAccess('_engine_seek');
var _engine_get_playhead = Module['_engine_get_playhead'] = makeInvalidEarlyAccess('_engine_get_playhead');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['engine_set_eq_band'] != 'undefined', 'missing Wasm export: engine_set_eq_band');
  assert(typeof wasmExports['engine_set_eq_enabled'] != 'undefined', 'missing Wasm export: engine_set_eq_enabled');
  ...
  assert(typeof wasmExports['engine_seek'] != 'undefined', 'missing Wasm export: engine_seek');
  assert(typeof wasmExports['engine_get_playhead'] != 'undefined', 'missing Wasm export: engine_get_playhead');
  ...
  _engine_set_eq_band = Module['_engine_set_eq_band'] = createExportWrapper('engine_set_eq_band', 5);
  _engine_set_eq_enabled = Module['_engine_set_eq_enabled'] = createExportWrapper('engine_set_eq_enabled', 2);
  ...
  _engine_seek = Module['_engine_seek'] = createExportWrapper('engine_seek', 1);
  _engine_get_playhead = Module['_engine_get_playhead'] = createExportWrapper('engine_get_playhead', 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = AudioEngineModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = AudioEngineModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => AudioEngineModule);
